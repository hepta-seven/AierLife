...
export default class PressAffirm extends React.Component {
    ...
    _refreshData() {
        ...
        NetUitl.get(API.APIList.normal_user_confirmed, myparams, function (res) {
            me._data = res.result;
            me.setState({
            ...
            <TouchableNativeFeedback onPress={() => {
                ...
                <View style={styles.doctorIntroductions}>
                    ...
                    <View style={styles.doctorIntroductionText}>
                        ...
                        <View>
                            <Text style={styles.doctorHospital}>{rowData.address}</Text>
                        </View>
                        <View>
                            <Text style={styles.doctorSuggest}>服务时间：{rowData.service_time}</Text>
                        </View>
                    </View>
                </View>
            </TouchableNativeFeedback>
